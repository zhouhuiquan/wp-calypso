...
class JetpackOnboardingContactFormStep extends React.PureComponent {
	handleAddContactForm = () => {
		...
		const token = get( this.state.jetpackOnboarding.credentials, [ siteId, 'token' ], null );
		const jpUser = get( this.state.jetpackOnboarding.credentials, [ siteId, 'userEmail' ], null );
